        ...
        <div class="nf-container clearfix">
            <div class="nf-field clearfix">
                <p class="nf-text danger" style="color:black;">
                    <?php if($sum > 9): ?>
                        По результатам тестирования - вероятна гипоксия. Возможен дефицит железа и/или ко-факторов. Вся информация о проблеме по ссылке:
                    <?php else:?>
                        Гипоксия маловероятна. Для профилактики гипоксии и развития дефицита железа можете изучить путеводитель:
                    <?php endif;?>
