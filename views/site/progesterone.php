...
<div class="anketa-content">
    <div class="anketa-form">
        ...
        <?= $form->field($model, 'q45')->textInput(['maxlength' => true, 'placeholder' => 'Ваш ответ']) ?>
        ...
        <?= $form->field($model, 'policy')->checkbox([
            'label' => 'Я хочу получить результат анализа моей ситуации! Я даю согласие на <a href="/files/consent.pdf" target="_blank" style="text-decoration: underline">Обработку персональных данных</a>',
            'labelOptions' => [
