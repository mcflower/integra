            ...
            <div class="woc-second">
                ...
                <div class="speakers clearfix">
                    <div class="sp-line">
                        ...
                        <div class="sp-text">
                            <u>Дадали Владимир Абдулаевич</u> - Доктор наук, проф.СЗГму им. Мечникова, доктор философии по натуральной медицин, сертифицированный консультант университета натуральной медицины (США), член Международной ассоциации микронутрициатологии
                ...
                <div class="speakers clearfix">
                    <div class="sp-line">
                        ...
                        <div class="sp-text">
                            <u>Герд Алевтина Михайловна</u> - к.м.н., терапевт, невролог, специалист в области интегративной медицины и клинической нутрициологии,  медицинский директор концептуальной ООО «Клиника Интегра»
                            <br><br><b>Тема: «Аутоимунные заболевания- пандемия 21 века. Заболевания детей и взрослых. Востановление здоровья и качества жизни».</b>
                            <ul>
                                <li>Вы получите практикоприменимые схемы восcтановления иммунной системы.</li>
                            </ul>
                        </div>
                    </div>
                    <div class="sp-line">
            ...
            <div class="cw-contact clearfix">
                ...
                if (true) {
                    ...
                    echo $form->field($model, 'activity')->dropDownList([
                                ...
                                'within' => 'С проживанием - 24 300 руб.'
