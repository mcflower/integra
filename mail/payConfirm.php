...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td class="ond-element-content"
            ...
            <p class="ond-paragraph" style="color: #000000; font-size: 16px; margin: 0px; font-family: Arial,Helvetica,sans-serif; text-indent: 0px; padding: 0px; line-height: 150%;"><a href='<?=$activity->url?>' target='_blank' style='color: rgb(141, 179, 147);font-weight:bold;text-decoration:underline;'>Ссылка на вебинар</a>. Не делитесь вашей ссылкой на вебинар, она уникальна и предоставляет доступ только одному участнику.</p><br>
            <p class="ond-paragraph" style="color: #000000; font-size: 16px; margin: 0px; font-family: Arial,Helvetica,sans-serif; text-indent: 0px; padding: 0px; line-height: 150%;">Ссылку на запись вы получите на следующий день после вебинара. Доступ к записи до <?=date('d.m.Y', ($activity->expired - 24 * 60 * 60))?>.</p><br>
            <hr>
