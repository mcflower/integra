...
<table border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
        <td class="ond-element-content"
            ...
            <p class="ond-paragraph" style="color: #000000; font-size: 16px; margin: 0px; font-family: Arial,Helvetica,sans-serif; text-indent: 0px; padding: 0px; line-height: 150%;">Доступ к записи до <?=date('d.m.Y', ($activity->expired - 24 * 60 * 60))?>.</p><br>
            <p class="ond-paragraph" style="color: #000000; font-size: 16px; margin: 0px; font-family: Arial,Helvetica,sans-serif; text-indent: 0px; padding: 0px; line-height: 150%;"><a href='https://integraforlife.com/yandex/record-payment?hash=<?= $user->hash ?>' target='_blank' style='text-decoration: none;color: rgb(141, 179, 147);font-weight:bold;text-decoration:underline;'>ПЕРЕЙТИ К ОПЛАТЕ</a></p><hr>
